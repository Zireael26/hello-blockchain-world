...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"Zireael26", "hello-blockchain-world", "helloblockchainworld", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Posts_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"Zireael26", "hello-blockchain-world", "helloblockchainworld", "posts"}, "", runtime.AssumeColonVerbOpt(true)))
)
